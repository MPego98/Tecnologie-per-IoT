...
void StartParameter(int result,float temperature)
{
  switch(result)
  {
     case 001: Tac_min_pres=temperature;break;

      case 011:Tac_max_pres=temperature;break;

      case 000:Tac_min_abs=temperature;break;

      case 010:Tac_max_abs=temperature;break;
